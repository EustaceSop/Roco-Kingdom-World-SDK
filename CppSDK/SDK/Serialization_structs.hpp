...
public:
	...
	struct FStructSerializerBuiltinTestStruct     Builtins;                                          // 0x0100(0x0090)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStructSerializerArrayTestStruct       Arrays;                                            // 0x0190(0x0060)(NativeAccessSpecifierPublic)
