...
// Enum Niagara.ELandscapeSettingMode
// NumValues: 0x0003
enum class ELandscapeSettingMode : uint8
{
	Manual                                   = 0,
	Auto                                     = 1,
	ELandscapeSettingMode_MAX                = 2,
};
...
struct alignas(0x08) FNiagaraEventGeneratorProperties final
{
public:
...
public:
	...
	TArray<class UNiagaraComponent*>              ComponentsToReset;                                 // 0x0008(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraComponent*>              ComponentsToReInit;                                // 0x0018(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraComponent*>              ComponentsToNotifySimDestroy;                      // 0x0028(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraSystem*>                 SystemSimsToDestroy;                               // 0x0038(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
...
// ScriptStruct Niagara.NiagaraPropertySetter
// 0x000C (0x000C - 0x0000)
struct alignas(0x04) FNiagaraPropertySetter final
{
public:
	bool                                          bIgnoreConversion;                                 // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0xB];                                        // 0x0001(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
DUMPER7_ASSERTS_FNiagaraPropertySetter;
