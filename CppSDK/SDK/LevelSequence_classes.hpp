...
public:
	...
	struct FSoftObjectPath                        LevelSequence;                                     // 0x0278(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	void ApplyWorldOffsetToSequence();
	void DestroyWorldOffsetActor();
	void HideBurnin();
...
{
public:
	TMulticastInlineDelegate<void(class UCameraComponent* CameraComponent)> OnCameraCut;             // 0x0680(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_690[0x110];                                    // 0x0690(0x0110)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FSoftObjectPath                        PathToLevelSequence;                               // 0x0038(0x0020)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class AActor*                                 TransformOriginActor_AbsCenter;                    // 0x0070(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FLevelSequencePlayerSnapshot           FrameInformation;                                  // 0x02A0(0x00C0)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	class ALevelSequenceActor*                    LevelSequenceActor;                                // 0x0360(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
// Class LevelSequence.LevelSequenceLayerFilterConfig
// 0x0000 (0x0030 - 0x0030)
class ULevelSequenceLayerFilterConfig final : public UDataAsset
{
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("LevelSequenceLayerFilterConfig")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"LevelSequenceLayerFilterConfig")
	}
	static class ULevelSequenceLayerFilterConfig* GetDefaultObj()
	{
		return GetDefaultObjImpl<ULevelSequenceLayerFilterConfig>();
	}
};
DUMPER7_ASSERTS_ULevelSequenceLayerFilterConfig;
