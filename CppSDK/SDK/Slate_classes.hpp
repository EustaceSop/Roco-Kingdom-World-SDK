...
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0030(0x0800)(Edit, NativeAccessSpecifierPublic)
...
{
public:
	struct FEditableTextStyle                     EditableTextStyle;                                 // 0x0030(0x0228)(Edit, NativeAccessSpecifierPublic)
...
{
public:
	struct FTextBlockStyle                        TextBlockStyle;                                    // 0x0030(0x0280)(Edit, NativeAccessSpecifierPublic)
