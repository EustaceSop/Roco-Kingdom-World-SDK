...
public:
	...
	TMulticastInlineDelegate<void(const struct FMagicLeapTouchpadGesture& GestureData)> OnTouchpadGestureStart; // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FMagicLeapTouchpadGesture& GestureData)> OnTouchpadGestureContinue; // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FMagicLeapTouchpadGesture& GestureData)> OnTouchpadGestureEnd; // 0x0100(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
