...
// 0x0010 (0x0010 - 0x0000)
struct EnhancedInputSubsystemInterface_SetMappingContextPriority final
{
public:
	const class UInputMappingContext*             MappingContext;                                    // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Priority;                                          // 0x0008(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
DUMPER7_ASSERTS_EnhancedInputSubsystemInterface_SetMappingContextPriority;
...
// 0x0020 (0x0020 - 0x0000)
struct InputMappingContext_ChangeMapKey final
{
public:
	const class UInputAction*                     Action;                                            // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FKey                                   NewKey;                                            // 0x0008(0x0018)(Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_InputMappingContext_ChangeMapKey;
...
public:
	...
	struct FEnhancedActionKeyMapping              ReturnValue;                                       // 0x0020(0x0048)(Parm, OutParm, ReturnParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
