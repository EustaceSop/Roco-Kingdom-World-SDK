...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08FD6B08;
	constexpr int32 AppendString      = 0x0348B650;
	constexpr int32 GNames            = 0x08FBD840;
	constexpr int32 GWorld            = 0x08A43CC8;
	constexpr int32 ProcessEvent      = 0x036CF100;
