...
public:
	...
	uint8                                         Pad_CB[0x1D];                                      // 0x00CB(0x001D)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   ImportanceLevel;                                   // 0x00E8(0x0018)(NativeAccessSpecifierPublic)
	uint64                                        Grading;                                           // 0x0100(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static void SetAllowGradingtTest(bool EffectHigh, bool EffectMedium, bool EffectLow, bool LightHigh, bool LightLow);
...
{
public:
	struct FMovieSceneSectionParameters           Parameters;                                        // 0x0108(0x0024)(Edit, BlueprintVisible, Config, NoDestructor, NativeAccessSpecifierPublic)
	...
	float                                         TimeScale;                                         // 0x0130(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         PrerollTime_MovieSceneSubSection;                  // 0x0134(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMovieSceneSequence*                    SubSequence;                                       // 0x0138(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TLazyObjectPtr<class AActor>                  ActorToRecord;                                     // 0x0140(0x001C)(Edit, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_15C[0x4];                                      // 0x015C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 TargetSequenceName;                                // 0x0160(0x0010)(Edit, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FDirectoryPath                         TargetPathToRecordTo;                              // 0x0170(0x0010)(Edit, Protected, NativeAccessSpecifierProtected)
...
{
public:
	struct FIntVector                             AbsCenter;                                         // 0x0050(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FMovieSceneBoolChannel                 BoolCurve;                                         // 0x0110(0x0090)(Protected, NativeAccessSpecifierProtected)
