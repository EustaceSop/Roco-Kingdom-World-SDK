...
// Function LevelSequence.LevelSequenceActor.ApplyWorldOffsetToSequence
// (Final, Native, Public, BlueprintCallable)

void ALevelSequenceActor::ApplyWorldOffsetToSequence()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LevelSequenceActor", "ApplyWorldOffsetToSequence");
...
// Function LevelSequence.LevelSequenceActor.DestroyWorldOffsetActor
// (Final, Native, Public, BlueprintCallable)

void ALevelSequenceActor::DestroyWorldOffsetActor()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LevelSequenceActor", "DestroyWorldOffsetActor");
...
// Function LevelSequence.LevelSequenceActor.RemoveSequence
// (Final, Native, Public, BlueprintCallable)

void ALevelSequenceActor::RemoveSequence()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LevelSequenceActor", "RemoveSequence");
