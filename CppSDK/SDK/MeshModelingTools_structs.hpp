...
enum class ECollisionGeometryMode : uint32
{
	Default                                  = 0,
	SimpleAndComplex                         = 1,
	UseSimpleAsComplex                       = 3,
	UseComplexAsSimple                       = 4,
	ECollisionGeometryMode_MAX               = 5,
};
...
// Enum MeshModelingTools.EVertexBrushLockDirection
// NumValues: 0x0005
enum class EVertexBrushLockDirection : uint8
{
	None                                     = 0,
	LockX                                    = 1,
	LockY                                    = 2,
	LockZ                                    = 4,
	EVertexBrushLockDirection_MAX            = 5,
};
