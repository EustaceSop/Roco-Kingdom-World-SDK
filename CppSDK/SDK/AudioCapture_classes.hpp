...
{
public:
	int32                                         JitterLatencyFrames;                               // 0x0710(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_714[0xBC];                                     // 0x0714(0x00BC)(Fixing Struct Size After Last Property [ Dumper-7 ])
