...
public:
	...
	class UBodySetup*                             ProcMeshBodySetup;                                 // 0x0580(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FBoxSphereBounds                       LocalBounds;                                       // 0x05A8(0x001C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_5C4[0x4];                                      // 0x05C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UBodySetup*>                     AsyncBodySetupQueue;                               // 0x05C8(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
