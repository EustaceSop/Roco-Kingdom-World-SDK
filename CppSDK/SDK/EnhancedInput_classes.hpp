...
public:
	...
	static struct FVector Conv_InputActionValueToAxis3D(const struct FInputActionValue& InValue);
...
public:
	...
	bool SetMappingContextPriority(const class UInputMappingContext* MappingContext, int32 Priority);
...
{
public:
	TArray<class UInputMappingContext*>           AppliedInputContexts;                              // 0x03A8(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	TMap<class UInputMappingContext*, int32>      AppliedInputContextsPriority;                      // 0x03B8(0x0050)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_408[0x50];                                     // 0x0408(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FEnhancedActionKeyMapping>      EnhancedActionMappings;                            // 0x0458(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_468[0x50];                                     // 0x0468(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class UInputAction*, struct FInputActionInstance> ActionInstanceData;                       // 0x04B8(0x0050)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_508[0xF0];                                     // 0x0508(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool                                          bBlock;                                            // 0x0058(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bActive;                                           // 0x0059(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5A[0x6];                                       // 0x005A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ChangeMapKey(const class UInputAction* Action, const struct FKey& NewKey);
