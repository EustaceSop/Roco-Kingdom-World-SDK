...
{
public:
	struct FPoseLink                              InputPose;                                         // 0x0018(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FLiveLinkSubjectName                   LiveLinkSubjectName;                               // 0x0038(0x0008)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FAnimNode_LiveLinkPose                 PoseNode;                                          // 0x0760(0x0068)(Edit, NativeAccessSpecifierPublic)
