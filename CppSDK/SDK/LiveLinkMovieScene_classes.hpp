...
{
public:
	struct FLiveLinkSubjectPreset                 SubjectPreset;                                     // 0x0108(0x0038)(NoDestructor, NativeAccessSpecifierPublic)
	TArray<bool>                                  ChannelMask;                                       // 0x0140(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class UMovieSceneLiveLinkSubSection*>  SubSections;                                       // 0x0150(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
