...
// ScriptStruct SpinePlugin.SpinePreviewAnimEntry
// 0x0018 (0x0018 - 0x0000)
struct FSpinePreviewAnimEntry final
{
public:
...
DUMPER7_ASSERTS_FSpinePreviewAnimEntry;

// ScriptStruct SpinePlugin.SpinePreviewTrack
// 0x0018 (0x0018 - 0x0000)
struct FSpinePreviewTrack final
{
public:
	int32                                         TrackIndex;                                        // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FSpinePreviewAnimEntry>         Queue;                                             // 0x0008(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_FSpinePreviewTrack;
