...
// Function MovieScene.MovieSceneSection.SetAllowGradingtTest
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// bool                                    EffectHigh                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    EffectMedium                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    EffectLow                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    LightHigh                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    LightLow                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMovieSceneSection::SetAllowGradingtTest(bool EffectHigh, bool EffectMedium, bool EffectLow, bool LightHigh, bool LightLow)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("MovieSceneSection", "SetAllowGradingtTest");

	Params::MovieSceneSection_SetAllowGradingtTest Parms{};

	Parms.EffectHigh = EffectHigh;
	Parms.EffectMedium = EffectMedium;
	Parms.EffectLow = EffectLow;
	Parms.LightHigh = LightHigh;
	Parms.LightLow = LightLow;
