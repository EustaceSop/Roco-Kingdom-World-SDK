...
struct FVector UEnhancedInputLibrary::Conv_InputActionValueToAxis3D(const struct FInputActionValue& InValue)
{
	static class UFunction* Func = nullptr;
...
// Function EnhancedInput.EnhancedInputSubsystemInterface.SetMappingContextPriority
// (BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
// const class UInputMappingContext*       MappingContext                                         (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   Priority                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool IEnhancedInputSubsystemInterface::SetMappingContextPriority(const class UInputMappingContext* MappingContext, int32 Priority)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("EnhancedInputSubsystemInterface", "SetMappingContextPriority");

	Params::EnhancedInputSubsystemInterface_SetMappingContextPriority Parms{};
...
// Function EnhancedInput.InputMappingContext.ChangeMapKey
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const class UInputAction*               Action                                                 (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FKey&                      NewKey                                                 (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UInputMappingContext::ChangeMapKey(const class UInputAction* Action, const struct FKey& NewKey)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("InputMappingContext", "ChangeMapKey");

	Params::InputMappingContext_ChangeMapKey Parms{};
