...
// Function SpinePlugin.SpineWidget.LuaSynchronizeProperties
// (Final, Native, Public, BlueprintCallable)

void USpineWidget::LuaSynchronizeProperties()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SpineWidget", "LuaSynchronizeProperties");
