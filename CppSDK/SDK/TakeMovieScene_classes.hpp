...
// 0x0380 (0x0488 - 0x0108)
class UMovieSceneTakeSection final : public UMovieSceneSection
{
public:
	struct FMovieSceneIntegerChannel              HoursCurve;                                        // 0x0108(0x0090)(NativeAccessSpecifierPublic)
	struct FMovieSceneIntegerChannel              MinutesCurve;                                      // 0x0198(0x0090)(NativeAccessSpecifierPublic)
	struct FMovieSceneIntegerChannel              SecondsCurve;                                      // 0x0228(0x0090)(NativeAccessSpecifierPublic)
	struct FMovieSceneIntegerChannel              FramesCurve;                                       // 0x02B8(0x0090)(NativeAccessSpecifierPublic)
	struct FMovieSceneFloatChannel                SubFramesCurve;                                    // 0x0348(0x00A0)(NativeAccessSpecifierPublic)
	struct FMovieSceneStringChannel               Slate;                                             // 0x03E8(0x00A0)(NativeAccessSpecifierPublic)
