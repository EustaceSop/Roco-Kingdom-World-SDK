...
// Function MediaAssets.MediaPlayer.OpenSourceWithSinkDepth
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UMediaSource*                     MediaSource                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   SinkDepth                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UMediaPlayer::OpenSourceWithSinkDepth(class UMediaSource* MediaSource, int32 SinkDepth)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MediaPlayer", "OpenSourceWithSinkDepth");

	Params::MediaPlayer_OpenSourceWithSinkDepth Parms{};

	Parms.MediaSource = MediaSource;
	Parms.SinkDepth = SinkDepth;
...
// Function MediaAssets.MediaTexture.SetForceClearFlag
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    flag                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMediaTexture::SetForceClearFlag(bool flag)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MediaTexture", "SetForceClearFlag");

	Params::MediaTexture_SetForceClearFlag Parms{};
