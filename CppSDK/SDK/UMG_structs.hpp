...
{
public:
	TArray<class FName>                           BrushPropertyNamePath;                             // 0x00D0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
...
{
public:
	struct FTextBlockStyle                        TextStyle;                                         // 0x0008(0x0280)(Edit, NativeAccessSpecifierPublic)
};
...
// ScriptStruct UMG.ReadOnlyTextViolation
// 0x0060 (0x0060 - 0x0000)
struct FReadOnlyTextViolation final
{
public:
	...
	class FString                                 WidgetClass;                                       // 0x0010(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AttemptedText;                                     // 0x0020(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 FunctionName;                                      // 0x0030(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 CallStack;                                         // 0x0040(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDateTime                              Timestamp;                                         // 0x0050(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         RepeatCount;                                       // 0x0058(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
DUMPER7_ASSERTS_FReadOnlyTextViolation;
...
public:
	...
	bool                                          bUseOuterWidgetTree;                               // 0x0008(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCanSelectRootWidget;                              // 0x0009(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A[0xA];                                        // 0x000A(0x000A)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
